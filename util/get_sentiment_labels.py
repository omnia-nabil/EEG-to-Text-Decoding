...
sentiment_labels_task1_csv_path = '/content/EEG-to-Text-Decoding/dataset/ZuCo/sentiment_labels_task1.csv'
...
output_dir = f'/content/EEG-to-Text-Decoding/dataset/ZuCo/task1-SR/sentiment_labels'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

with open(os.path.join(output_dir, 'sentiment_labels.json'), 'w') as out:
    json.dump(sentiment_labels,out,indent = 4)
    print('write to /content/EEG-to-Text-Decoding/dataset/ZuCo/task1-SR/sentiment_labels/sentiment_labels.json')
