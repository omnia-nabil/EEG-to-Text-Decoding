...
def get_SST_dataset(SST_dir_path, ZuCo_used_sentences, ZUCO_SENTIMENT_LABELS):
    ...
    with open('/content/EEG-to-Text-Decoding/dataset/stanfordsentiment/stanfordSentimentTreebank/ternary_dataset.json', 'w') as out:
        json.dump(filtered_ternary_dataset,out, indent = 4)
    print('write json to /content/EEG-to-Text-Decoding/dataset/stanfordsentiment/stanfordSentimentTreebank/ternary_dataset.json')

if __name__ == '__main__':
    print('##############################')
    print('start generating stanfordSentimentTreebank ternary sentiment dataset...')
    SST_dir_path = '/content/EEG-to-Text-Decoding/dataset/stanfordsentiment/stanfordSentimentTreebank/'
    ZuCo_task1_csv_path = '/content/EEG-to-Text-Decoding/dataset/ZuCo/sentiment_labels_task1.csv'
