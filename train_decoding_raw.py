...
if __name__ == '__main__':
    ...
    if skip_step_one:
        if load_step1_checkpoint:
            stepone_checkpoint = '/kaggle/input/train-step-2-first-time/checkpoints/decoding_raw/best/task1_task2_taskNRv2_finetune_BrainTranslator_skipstep1_b20_14_14_5e-05_5e-05_unique_sent.pt'
